...
export default function News({ title, description, date, image }) {
    return (
        <motion.div 
            ...
            className="relative bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-2xl w-72" // Fixed width
        >
            ...
            <div className="p-4 flex flex-col justify-between h-32">
                ...
                <p className="mt-2 text-gray-700 text-sm line-clamp-3 overflow-hidden">{description}</p>
            </div>

            {/* Read More Button */}
            <div className="px-4 pb-4">
                <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-full text-xs font-semibold shadow-md hover:bg-blue-700 transition duration-300 flex items-center justify-center">
